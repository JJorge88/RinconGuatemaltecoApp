...
{
    /// <inheritdoc />
    public partial class AddDespachos : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalleDespachos", x => x.DetalleID);
                    table.ForeignKey(
                        name: "FK_DetalleDespachos_Despachos_DespachoID",
                        column: x => x.DespachoID,
                        principalTable: "Despachos",
                        principalColumn: "DespachoID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetalleDespachos_Productos_ProductoID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleDespachos_DespachoID",
                table: "DetalleDespachos",
                column: "DespachoID");

            migrationBuilder.CreateIndex(
                name: "IX_DetalleDespachos_ProductoID",
                table: "DetalleDespachos",
                column: "ProductoID");
